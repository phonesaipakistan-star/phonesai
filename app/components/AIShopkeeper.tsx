                ...
                <div className="ml-9 mt-2 flex flex-col gap-2 w-full max-w-[80%]">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 px-3 py-2.5">
                    ...
                    <p className="text-[10px] text-white/40 mt-0.5">
                      {msg.cartItem.storage} • {msg.cartItem.color}
                      {msg.cartItem.selected_condition_grade && msg.cartItem.selected_condition_grade !== "New" ? ` • ${msg.cartItem.selected_condition_grade}` : ""}
                      {" • "}{msg.cartItem.category}
                    </p>
