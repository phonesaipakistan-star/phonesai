        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="https://wa.me/923041502560" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/50 transition hover:text-white">
                  <span className="text-green-400">●</span> WhatsApp: 0304-1502560
                </a>
              </li>
              <li>
