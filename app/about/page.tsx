      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="space-y-6 text-white/60 leading-relaxed text-sm">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 space-y-3">
            ...
            <div className="flex items-center gap-3"><span className="text-xl">??</span><a href="https://wa.me/923200801010" className="text-blue-400 hover:underline">WhatsApp: 0320-0801010</a></div>
